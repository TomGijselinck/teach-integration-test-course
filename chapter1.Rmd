...
--- type:PlainMultipleChoiceExercise xp:50 key:98cc2b12f5
## What is, what isn't?
...
*** =sct
```{r}
msg1 = "Incorrect, try again. Although spam filtering is clearly a Machine Learning problem, obtaining the name of last year's Giro champion can be simply extracted by sorting a list of competitors. Try one more time!"
msg2 = "Darn, you almost got it. While photo recognition is a common example of a classification problem, identifying the top scoring student can be solved by sorting a list of scores. Try again!"
msg3 = "Great job! Both spam detection and photo recognition are common examples of classification. Go on to the next exercise to learn more!"
msg4 = "Incorrect. Neither selecting last year's Giro champion nor the top scoring student are machine learning problems. In these cases, all you need is to sort your data to get an answer!"
...
--- type:PlainMultipleChoiceExercise xp:50 key:2c27bd069e
...
*** =sct
```{r}
msg1 = "Incorrect, try again. Recommender systems are typical machine learning implementations to anticipate users preferences."
msg2 = "Incorrect, try again. Identifying illnesses out of symptoms can be tackled as a classification problem."
msg3 = "Incorrect, try again. Forecasting is a typical regression problem: You take historical data and try to predict future values of that type of data."
msg4 = "Good Job! Computing a mean is not machine learning!"
...
--- type:PlainMultipleChoiceExercise xp:50 key:47bc012c89
...
*** =sct
```{r}
msg1 <- "Incorrect, try again. Dependence of exchange rate on GDP looks more like a time series analysis, the trend line is often found using Regression."
msg2 <- "Fantastic Job! Identifying whether a letter is or isn't present in a handwritten text is a perfect example of a classification problem. You know in advance there are two possible categories: Either a scribble is the Letter S or it is not! It's time to tackle a very common classification problem: Spam Filtering."
msg3 <- "Nope, try again. Clustering is more suitable here, to identify potential categories out of a group of observations, without knowing what the expected categories are in advance."
...
--- type:PlainMultipleChoiceExercise xp:50 key:252947ec5a
## Tell the difference
...
*** =sct
```{r, eval=FALSE}
msg1 = "Oops! One of those is not supervised! Ask yourself the question: which problems would require you to train on a labeled dataset?"
msg2 = "Almost! One of those is not supervised! Ask yourself the question: which problems would require you to train on a labeled dataset?"
msg3 = "Nice! Grouping the students into three different groups will require features of the students, but you don't require a label. You just want to measure if the students are alike, based on their features. "
msg4 = "Oh ow! That's not right! Ask yourself the question: which problems would require you to train on a labeled dataset?"
test_mc(correct = 3, feedback_msgs = c(msg1,msg2,msg3,msg4))
```
